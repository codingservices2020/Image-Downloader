            ...
            try:
                ...
                await context.bot.send_message(
                    ...
                    text=f"<b>🔰SUBSCRIPTION EXPIRED🔰</b>\n\n"
                         ...
                         f"removed from ShutterStock Premium channel.",
                    parse_mode="HTML"
                )
                await context.bot.send_message(
                    chat_id=chat_id,
                ...
                logger.info(f"Removed expired user {chat_id} from the premium channel.")
            except Exception as e:
...
async def total_codes(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        try:
            ...
            await update.message.reply_text(f"Total remaining codes: {count}")
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        button_text = "Access Downloader" if is_premium else "🚀Make Payment🚀"
...
Need help? Contact Admin @coding_services
"""
    )
